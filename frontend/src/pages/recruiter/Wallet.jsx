              ...
              transactions.filter(t => {
                ...
                >
                  <div className="flex items-center gap-4">
                    <div className={`w-12 h-12 flex items-center justify-center border-2 border-brand-dark shadow-sm ${t.status === 'pending' ? 'bg-amber-100 text-amber-600' :
                  ...
                  <div className="flex items-center justify-between md:justify-end gap-6">
                    <div className="text-right flex flex-col items-end">
                      <div className="flex items-center gap-2">
                        ...
                        <p className={`text-xl font-black ${t.status === 'pending' ? 'text-amber-600' :
                      ...
                      <p className="text-[10px] font-black uppercase text-brand-primary">
                        {(Number(t.fees) || 0) > 0 ? `Incl. ₹${fmt(t.fees)} Fee` : t.method}
                      </p>
                    </div>
